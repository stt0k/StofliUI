  ...
  return (
    <>
      {isInDocsPage ? (
        <Button
          variant="outline"
          className="w-full h-8 sm:h-9 px-2 sm:px-4 justify-between text-xs sm:text-sm text-neutral-500 dark:text-neutral-400 bg-white dark:bg-zinc-950/50 border border-zinc-200 dark:border-zinc-800 hover:bg-transparent dark:hover:bg-transparent hover:border-zinc-400 dark:hover:border-zinc-700 transition-colors rounded-lg sm:rounded-xl"
        ...
        >
          ...
          <kbd className="pointer-events-none inline-flex h-4 sm:h-5 select-none items-center gap-1 rounded border border-zinc-200 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 px-1 sm:px-1.5 font-mono text-[8px] sm:text-[10px] font-medium text-neutral-600 dark:text-neutral-400">
        ...
        <Button
          variant="ghost"
          className={cn(
            "relative justify-center h-9 w-9 text-sm rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800 text-neutral-950/90 dark:text-neutral-50 p-0"
          )}
          onClick={() => setOpen(true)}
          {...props}
        >
