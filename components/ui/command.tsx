...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-white text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50 dark:border-0",
      className
    )}
    {...props}
  />
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0">
        ...
        <DialogDescription className="sr-only">Interfaz de comando para búsqueda rápida</DialogDescription>
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-zinc-500/50 px-3" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 h-px bg-zinc-200 dark:bg-zinc-500/50", className)}
    {...props}
  />
))
