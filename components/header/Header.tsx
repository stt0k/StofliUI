...
const Header = () => {
  ...
  <div className="mx-3">
    <header className="container border-border/40 border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-gray-200 dark:border-zinc-500/20 rounded-xl">
