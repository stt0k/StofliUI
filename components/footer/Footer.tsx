...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-black mt-44 text-white py-8">
      <div className="container mx-auto flex flex-col items-center">
        <div className="flex flex-col md:justify-between md:flex-row w-full mb-6">
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-semibold text-black dark:text-white">stofli/ui</h2>
          ...
          <div className="flex mt-4 md:mt-0 space-x-10 flex-col items-center">
            ...
            <div className='flex gap-x-5'>
              ...
              {linksDocs.map((item) => (
                  <a key={item.name} href={item.href} className="text-zinc-600 hover:text-slate-950 dark:text-zinc-400 dark:hover:text-zinc-300">{item.name}</a>
              ))}
            </div>
            <div className="mt-2 text-sm space-y-2 flex flex-col">
