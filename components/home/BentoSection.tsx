      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="col-span-1 md:col-span-2 bg-black rounded-xl overflow-hidden border border-zinc-800/40 shadow-xl group"
          >
            <div className="flex flex-col md:flex-row h-full">
              ...
              <div className="md:w-1/2 p-6 flex items-center justify-center">
                <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
                  <div className="bg-black/60 rounded-lg border border-zinc-800 p-4 hover:border-zinc-600 transition-colors group-hover:shadow-md">
                    <div className="mb-2">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
            viewport={{ once: true }}
            className="col-span-1 bg-black rounded-xl overflow-hidden border border-zinc-800/40 shadow-xl"
          >
            <div className="p-6">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <Button
                variant="ghost"
                className="text-zinc-400 hover:text-white mt-3 px-0"
            ...
            <div className="p-4">
              <div className="bg-black/40 rounded-lg p-3">
                <div className="flex items-center mb-3">
                  <span className="bg-zinc-800 text-white text-xs px-2 py-0.5 rounded mr-2">
                    &lt;5KB
                  </span>
                ...
                <div className="border-l-2 border-zinc-800 pl-3 my-2">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="col-span-1 bg-black rounded-xl overflow-hidden border border-zinc-800/40 shadow-xl group  transition-all duration-500"
          >
            <div className="p-6">
              <h3 className="text-xl font-bold text-white mb-3">
            ...
            <div className="p-4 flex flex-col items-center justify-center relative h-48 transition-all duration-500">
              ...
              <div className="relative w-full mx-auto transition-all duration-500 ease-out transform group-hover:-translate-y-4 group-hover:scale-105">
                ...
                <div className="absolute left-0 right-0 bottom-0 h-28 bg-black/20 blur-md rounded-xl -z-10 transition-all duration-500 group-hover:bg-black/30 group-hover:h-32"></div>

                {/* Notificación 4 */}
                <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 w-[75%] h-7 bg-zinc-800/60 rounded-lg shadow-sm transition-all duration-600 ease-in-out group-hover:-translate-y-2.5 group-hover:opacity-70"></div>

                {/* Notificación 3 */}
                <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-[82%] h-8 bg-zinc-800/80 rounded-lg shadow-md transition-all duration-500 ease-in-out group-hover:-translate-y-2 group-hover:opacity-80"></div>

                {/* Notificación 2 */}
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-[90%] bg-zinc-800/95 rounded-lg shadow-lg h-10 overflow-hidden transition-all duration-400 ease-in-out group-hover:-translate-y-1.5 group-hover:opacity-90">
                  {/* Solo mostrar una línea de contenido para la segunda notificación */}
                  <div className="h-full border-b border-zinc-700/30 px-4 py-3">
                    <div className="flex items-center">
                      <div className="w-4 h-4 rounded-sm bg-purple-500/80 flex-shrink-0"></div>
                      <div className="ml-2 h-2 bg-white/60 w-1/2 rounded"></div>
                    </div>
                  </div>
                </div>

                {/* Notificación principal (la que está hasta arriba del stack) */}
                <div className="relative bg-zinc-800 rounded-lg border border-zinc-700/50 shadow-2xl w-full overflow-hidden transition-all duration-300 ease-in-out group-hover:shadow-indigo-500/20 group-hover:border-zinc-700/80">
                  <div className="flex justify-between items-center px-4 py-3 border-b border-zinc-700/50 transition-all duration-500 group-hover:bg-zinc-800/90">
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-white text-sm group-hover:text-indigo-50 transition-colors duration-300">
                        Sistema de tokens
                      </span>
                    </div>
                  ...
                  <div className="p-3.5 group-hover:bg-zinc-800/80 transition-all duration-500">
                    <p className="text-sm text-white leading-snug">
                      <span className="font-medium text-amber-400 group-hover:text-amber-300 transition-colors duration-300">
                        @tokens
                      </span>{" "}
          ...
          >
            <div className="p-6 h-full flex flex-col">
              ...
              <div className="mt-6 space-y-3">
                <div className="p-4 rounded-md bg-zinc-900/80 border border-zinc-800/60 flex items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="col-span-1 bg-black rounded-xl overflow-hidden border border-zinc-800/40 shadow-xl group relative"
          >
            <div className="p-6">
              <h3 className="text-xl font-bold text-white mb-3">
              ...
              <Button
                variant="ghost"
                className="text-zinc-400 hover:text-white mt-3 px-0 group"
                rightIcon={
            ...
            <div className="p-4 relative h-48 overflow-hidden flex items-center">
              <div className="w-full">
                <div className="absolute left-0 top-4 bottom-4 w-8 bg-gradient-to-r from-black to-transparent z-10"></div>
                <div className="absolute right-0 top-4 bottom-4 w-8 bg-gradient-to-l from-black to-transparent z-10"></div>

                <div className="flex space-x-2 overflow-hidden py-2">
                  <div className="flex space-x-2 animate-infinite-scroll whitespace-nowrap">
                    <div className="flex-shrink-0 bg-zinc-950 hover:bg-zinc-800 border border-zinc-800 rounded-full py-1.5 px-3 flex items-center space-x-1.5 transition-colors">
                ...
                <div className="mt-6 flex justify-center">
                  <div className="bg-zinc-950 hover:bg-zinc-800 border border-zinc-800 rounded-lg py-2 px-4 flex items-center space-x-2.5 transition-colors">
