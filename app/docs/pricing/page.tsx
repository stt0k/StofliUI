  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-7xl mx-auto border border-zinc-900 bg-black">
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-zinc-800">
            <div className="p-8 flex flex-col">
              ...
              <button className="bg-zinc-800 text-white hover:bg-zinc-700 w-full py-2 px-4 font-medium transition mb-8">
                Comenzar
              </button>
            ...
            <div className="p-8 flex flex-col">
              ...
              <div className="mt-5 mb-4">
                ...
                <span className="text-gray-400 ml-1 block text-sm">/mes</span>
              </div>

              <button className="w-full py-2 px-4 bg-teal-500 text-black font-medium hover:bg-teal-400 transition mb-8">
                Seleccionar plan
              </button>

              <p className="mb-6">
                Componentes independientes adaptados a tus necesidades.
              </p>
        ...
        <div className="max-w-7xl mx-auto border-b border-r border-l border-zinc-900 bg-black">
          <div className="text-center p-8 border-b border-zinc-900">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-zinc-900">
                  <th className="p-6 text-left border-r border-zinc-900"></th>
                  <th className="p-6 text-center border-r border-zinc-900">
                    <div className="font-bold">Gratis</div>
                    <div className="text-sm text-gray-400">$0/mes</div>
                  </th>
                  <th className="p-6 text-center border-r border-zinc-900">
                    <div className="font-bold">Componentes Pro</div>
                    <div className="text-sm text-gray-400">$4995/mes</div>
                  </th>
                  <th className="p-6 text-center border-r border-zinc-900">
                    <div className="font-bold">Páginas</div>
                    <div className="text-sm text-gray-400">$6995/mes</div>
                  </th>
                  <th className="p-6 text-center border-r border-zinc-900">
                    <div className="font-bold">Aplicaciones Web</div>
                    <div className="text-sm text-gray-400">$9995/mes</div>
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-zinc-900">
                  <td className="p-6 font-medium border-r border-zinc-900">
                    Componentes
                  </td>
                  <td className="p-6 text-center border-r border-zinc-900">
                    <div>Biblioteca creciente</div>
                    <div className="text-sm text-gray-400">Uso gratuito</div>
                  </td>
                  <td className="p-6 text-center border-r border-zinc-900">
                    <div>Tantos como sea posible</div>
                    <div className="text-sm text-gray-400">en un mes</div>
                  </td>
                  <td className="p-6 text-center border-r border-zinc-900">
                    <div>Una solicitud / página</div>
                    <div className="text-sm text-gray-400">a la vez</div>
                  </td>
                  <td className="p-6 text-center border-r border-zinc-900">
                    <div>Un proyecto</div>
                    <div className="text-sm text-gray-400">a la vez</div>
