          ...
          <div className="mx-auto w-full min-w-0">
            ...
            <div className="space-y-2">
              ...
              <p className="text-lg text-zinc-500 dark:text-zinc-400">
                Beautiful components, ready to be seamlessly integrated into
                your projects. Fully accessible, easily customizable, and
                open-source.
              </p>
            </div>
            <div className="pb-12 pt-8">
              <div className="flex flex-col gap-4 text-lg">
                <p className="text-lg text-zinc-500 dark:text-zinc-400">
                  This is not a traditional component library—it&apos;s a
                  curated collection of reusable components designed for direct
                  use in your applications.
                </p>
                <p className="text-lg text-zinc-500 dark:text-zinc-400">
                  What do we mean by not a component library? Unlike
                  conventional libraries, there’s no need to install
                  dependencies or use npm. Instead, simply select the components
                  you need, copy the code, and integrate it directly into your
                  project.
                </p>
                <p className="text-lg text-zinc-500 dark:text-zinc-400">
            ...
            <div className="space-y-6">
              <h2 className="mt-10 scroll-m-20 border-b border-[#E4E4E7] dark:border-[#27272A] pb-2 text-2xl font-semibold tracking-tight">
                FAQ
              </h2>
              <div className="space-y-4">
                <details className="group [&_summary::-webkit-details-marker]:hidden">
                  ...
                  <div className="px-4 py-3 text-zinc-500 dark:text-zinc-400">
                    The idea is to give you full ownership and control over the
                    code, allowing you to determine how the components are built
                    and styled.
                  </div>
                </details>
                {/* FAQ items */}
