    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 pb-12">
        ...
        <div className="text-center mb-20">
          <h1 className="scroll-m-20 text-6xl font-extrabold tracking-tight lg:text-7xl mb-4 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            <Card className="bg-zinc-900 border border-zinc-800 overflow-hidden">
              <div className="border-b border-zinc-800 flex flex-col lg:flex-row items-stretch">
                <div className="w-full lg:w-60 border-b lg:border-b-0 lg:border-r border-zinc-800 py-4 px-4">
                ...
                <div className="flex-1 min-h-[400px] lg:min-h-[600px]">
                  <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-zinc-800">
                    ...
                    <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center space-y-2 sm:space-y-0 sm:space-x-2">
                      ...
                      <div className="relative flex items-center w-full sm:w-auto">
                        ...
                        <input
                          type="text"
                          placeholder="Search..."
                          className="w-full sm:w-64 bg-transparent border border-zinc-800 rounded-md pl-10 py-2 text-white focus:outline-none focus:border-blue-600"
                        />
                      </div>
                      <Avatar
                        fallback="JD"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <Mail className="h-4 w-4 text-zinc-400 absolute left-3" />
                      <input
                        type="email"
                        placeholder="ejemplo@stofli.com"
                        className="w-full bg-transparent border border-zinc-800 rounded-md pl-10 py-2 text-white focus:outline-none focus:border-blue-600"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <Lock className="h-4 w-4 text-zinc-400 absolute left-3" />
                      <input
                        type="password"
                        placeholder="••••••••"
                        className="w-full bg-transparent border border-zinc-800 rounded-md pl-10 py-2 text-white focus:outline-none focus:border-blue-600"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      />
                      <label className="text-sm text-zinc-300 ml-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder="John"
                        className="w-full bg-transparent border border-zinc-800 rounded-md px-3 py-2 text-white focus:outline-none focus:border-blue-600"
                      />
                    </div>
                    <div>
                      <label className="text-sm text-zinc-400 block mb-1">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-zinc-900 border border-zinc-800 overflow-hidden p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div className="bg-zinc-800/50 rounded-md p-2">
                      ...
                      <p className="text-zinc-400 text-xs">Proyectos</p>
                    </div>
                    <div className="bg-zinc-800/50 rounded-md p-2">
                      <p className="text-2xl font-bold">142</p>
                      <p className="text-zinc-400 text-xs">Seguidores</p>
                    </div>
                  </div>
              ...
              <Card className="bg-zinc-900 border border-zinc-800 overflow-hidden p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-start space-x-4 p-3 rounded-lg hover:bg-zinc-800/50 transition-colors"
                    >
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-full mt-4 flex items-center justify-center text-zinc-400 hover:text-white transition-colors"
                >
            ...
            <Card className="bg-zinc-900 border border-zinc-800 overflow-hidden">
              ...
              <div className="px-3 sm:px-6 relative">
                <div className="flex flex-col sm:flex-row sm:items-end -mt-12 sm:-mt-16 mb-4 sm:mb-6">
                  <div className="h-24 w-24 sm:h-32 sm:w-32 ring-4 ring-zinc-900 rounded-full overflow-hidden mx-auto sm:mx-0 relative">
                    <Image
              ...
              <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="bg-zinc-800/50 p-3 sm:p-4 rounded-lg">
                  ...
                  <div className="flex flex-wrap justify-between mt-3 pt-3 border-t border-zinc-700">
                ...
                {[
                  ...
                  <div
                    key={index}
                    className="bg-zinc-800/50 p-3 sm:p-4 rounded-lg"
                  >
                    <div className="flex space-x-2 sm:space-x-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center">
                          ...
                          <span className="text-zinc-500 text-xs ml-1 sm:ml-2">
                            · {post.time}
                          </span>
                        </div>
                    ...
                    <div className="flex justify-around py-2">
                      <button className="flex items-center space-x-1 sm:space-x-1.5 text-zinc-500 hover:text-blue-500 transition-colors">
                        <MessageCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                        <span className="text-xs">{post.comments}</span>
                      </button>

                      <button className="flex items-center space-x-1 sm:space-x-1.5 text-zinc-500 hover:text-green-500 transition-colors">
                        <Repeat className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                        <span className="text-xs">{post.shares}</span>
                      </button>

                      <button className="flex items-center space-x-1 sm:space-x-1.5 text-zinc-500 hover:text-red-500 transition-colors">
  ...
  return (
    <div className="p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card className="p-4 bg-zinc-900/80 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-zinc-300 font-medium">Ingresos</h3>
            <Badge variant="success">+12.5%</Badge>
          </div>
          <p className="text-2xl font-bold text-white mb-2">$15,231.89</p>
          <p className="text-zinc-400 text-sm">Comparado al mes anterior</p>
        </Card>
        <Card className="p-4 bg-zinc-900/80 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-zinc-300 font-medium">Usuarios</h3>
            <Badge variant="primary">+24.8%</Badge>
          </div>
          <p className="text-2xl font-bold text-white mb-2">2,543</p>
          <p className="text-zinc-400 text-sm">Nuevos usuarios este mes</p>
        </Card>
        <Card className="p-4 bg-zinc-900/80 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-zinc-300 font-medium">Conversión</h3>
            <Badge variant="warning">-2.3%</Badge>
          </div>
          <p className="text-2xl font-bold text-white mb-2">3.42%</p>
          <p className="text-zinc-400 text-sm">Tasa de conversión</p>
        </Card>
      </div>

      <Card className="p-4 bg-zinc-900/80 border border-zinc-800 hover:border-zinc-700 transition-all duration-300 mb-4">
        ...
        <div className="flex justify-between mt-4">
          <span className="text-zinc-400 text-sm">Enero</span>
          <span className="text-zinc-400 text-sm">Diciembre</span>
        </div>
      </Card>
    </div>
  );
