    ...
    return (
      <div className="relative group overflow-hidden rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
        ...
        <div className="p-2 md:p-3 bg-white border border-gray-200 dark:bg-zinc-900 dark:border-zinc-800">
                ...
                <AnimatePresence initial={false} mode="sync">
                  {copiedColor === shade[format] ? (
                    ...
                    <motion.div
                      ...
                      exit={{ opacity: 0 }}
                      transition={{ duration: 0.2 }}
                      className="absolute inset-0 flex items-center justify-center text-gray-500 group-hover:text-gray-700 dark:text-neutral-400 dark:group-hover:text-zinc-100"
                    >
          ...
          <div
            className="font-mono text-xs text-gray-600 dark:text-neutral-400 break-all select-all cursor-pointer truncate md:truncate-none"
