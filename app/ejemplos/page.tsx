        ...
        <div className="text-center mb-20">
          <h1 className="scroll-m-20 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4">
            ...
            <span className="hidden md:inline">
              de componentes <br /> para interfaces StofliUI
            </span>
          </h1>
          <p className="text-base md:text-xl text-gray-600 dark:text-neutral-400 leading-relaxed max-w-3xl mx-auto">
                      ...
                      <div
                        ...
                        className={`flex items-center px-3 py-2 rounded-md cursor-pointer ${
                          item.active
                            ...
                            : "text-gray-700 dark:text-neutral-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-zinc-800/50"
                        }`}
                      >
                        {item.icon}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="hidden sm:flex items-center gap-3">
                        ...
                        <div className="relative w-64">
                          <Search className="h-4 w-4 text-gray-400 dark:text-neutral-400 absolute left-3 top-1/2 -translate-y-1/2" />
                          <input
                            type="text"
                            placeholder="Search..."
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-sm text-gray-500 dark:text-neutral-400 block mb-1">
                      Email
                    </label>
                    <div className="relative flex items-center">
                      <Mail className="h-4 w-4 text-gray-400 dark:text-neutral-400 absolute left-3" />
                      <input
                        type="email"
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <Lock className="h-4 w-4 text-gray-400 dark:text-neutral-400 absolute left-3" />
                      <input
                        type="password"
                        placeholder="••••••••"
                        className="w-full bg-gray-50 dark:bg-transparent border border-gray-200 dark:border-zinc-800 rounded-md pl-10 py-2 text-gray-900 dark:text-white focus:outline-none focus:border-blue-600"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 overflow-hidden p-6">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-full mt-4 flex items-center justify-center text-gray-500 dark:text-neutral-400 hover:text-gray-700 dark:hover:text-white transition-colors"
                >
