    ...
    <div className="flex flex-col min-h-screen dark:bg-zinc-950 bg-white dark:text-white max-w-screen">
      ...
      <section className="relative z-10">
        <div className="flex items-start justify-center min-h-screen container max-w-7xl z-10">
          <div className="w-full space-y-7 flex justify-center flex-col items-center text-center sm:mt-44 mt-36">
            <TagHome />
            <div className="absolute left-1/2 top-1/2 -z-10 h-[400px] w-[800px] -translate-x-1/2 -translate-y-1/2 opacity-10 blur-[100px] bg-emerald-500 pointer-events-none" />{" "}
      ...
      <div className="flex flex-col container text-center lg:text-left relative z-10">
        <p className="tracking-tight inline text-center font-semibold text-4xl lg:text-6xl mb-12 text-gray-900 dark:text-white">
          A{" "}
          <span className="tracking-tight inline font-semibold from-yellow-100 to-yellow-400 text-4xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-b">
      ...
      <div className="flex flex-col container text-center lg:text-left relative z-10">
        <p className="tracking-tight inline text-center font-semibold text-4xl lg:text-6xl mb-12 mt-52 text-gray-900 dark:text-white">
          <span className="tracking-tight inline font-semibold from-[#6FEE8D] to-[#17c964] text-4xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-b">
            Beautiful
          </span>
          <br />
          examples of use
