...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-black text-white w-full overflow-x-hidden">
      <Header />
      <main className="flex-1 w-full max-w-[100vw] px-4 sm:px-6 lg:px-8 pt-28">
        ...
        <section className="relative z-10">
          <div className="flex items-start justify-center min-h-screen mx-auto max-w-7xl z-10">
            <div className="w-full space-y-7 flex justify-center flex-col items-center text-center sm:mt-44 mt-36">
              ...
              <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl px-4">
                A fast, modern, and easy-to-use UI component library for your
                web projects.
              </p>
              <ButtonHome />
            </div>
        ...
        {/* Rest of the content */}
        <div className="flex flex-col mx-auto max-w-7xl text-center lg:text-left relative z-10">
