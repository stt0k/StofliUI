    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-16">
          ...
          <p className="text-base md:text-xl text-gray-600 dark:text-neutral-400 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-zinc-800">
            <div className="p-8 flex flex-col">
              ...
              <div className="mt-5 mb-4">
                ...
                <span className="text-gray-500 dark:text-neutral-400 ml-1 block text-sm">
                  por mes
                </span>
              </div>
