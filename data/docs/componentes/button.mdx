...
```
    ...
    <div className="mt-6">
      <HeadingAnchor id="efecto-ripple" level={3} >Efecto Ripple</HeadingAnchor>
...
```
    ...
    <div className="mt-6">
      <HeadingAnchor id="efecto-clic" level={3} >Efecto de Clic</HeadingAnchor>
...
```
    ...
    <div className="mt-6">
      <HeadingAnchor id="estados-carga" level={3} >Estados de Carga</HeadingAnchor>
...
export const toc = [
  ...
  { title: "Uso", href: "#uso" },
  {
    ...
    children: [
      ...
      { title: "Efecto Ripple", href: "#efecto-ripple" },
      { title: "Efecto de Clic", href: "#efecto-clic" },
      { title: "Con iconos", href: "#con-iconos" },
      { title: "Estados de Carga", href: "#estados-carga" },
