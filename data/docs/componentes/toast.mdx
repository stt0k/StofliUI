...
````
    ...
    <div className="mt-6">
      <HeadingAnchor id="duracion-personalizada" level={3} >Duración personalizada</HeadingAnchor>
...
````
    ...
    <div className="mt-6">
      <HeadingAnchor id="multiples-toasts" level={3} >Múltiples Toasts en cola</HeadingAnchor>
...
````
    ...
    <div className="mt-6">
      <HeadingAnchor id="usando-botones" level={3} >Usando botones para mostrar toasts</HeadingAnchor>
...
export const toc = [
  ...
  { title: "Uso", href: "#uso" },
  {
    ...
    children: [
      ...
      { title: "Duración personalizada", href: "#duracion-personalizada" },
      { title: "Múltiples Toasts en cola", href: "#multiples-toasts" },
      { title: "Con clases personalizadas", href: "#clases-personalizadas" },
      { title: "Usando botones para mostrar toasts", href: "#usando-botones" },
    ],
  },
